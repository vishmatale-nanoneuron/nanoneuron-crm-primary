...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "DevOps AI — Deployment Risk Scoring, DORA Metrics & Incident Correlation",
    description: "Find which deploy caused the incident. Upload pipeline logs, get DORA scores and change failure analysis in 30 seconds.",
  },
};
...
export default function DevOpsAI() {
  return (
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <IndustryKPIShowcase industry="devops" currentHref="/devops-ai" />
      ...
      <VerticalOutputPreview industry="devops" />
      ...
      <VerticalFooter currentHref="/devops-ai" industryName="DevOps" />
    </div>
  );
}
