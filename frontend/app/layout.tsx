...
export const metadata: Metadata = {
  ...
  description:
    "Vertical AI for logistics, manufacturing and warehouse operations. Upload CSV, Excel or PDF reports — get AI-powered risk scores, delay predictions and executive summaries in under 30 seconds.",
