...
export default function ManufacturingAI() {
  return (
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <IndustryKPIShowcase industry="manufacturing" currentHref="/manufacturing-ai" />
      ...
      <VerticalOutputPreview industry="manufacturing" />
      ...
      <VerticalFooter currentHref="/manufacturing-ai" industryName="Manufacturing" />
    </div>
  );
}
