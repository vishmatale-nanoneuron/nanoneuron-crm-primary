        ...
        <div className="card max-w-xl mb-4 border-white/8">
          ...
          <div className="flex gap-2 flex-wrap">
            {[
              ...
              { id: "devops", label: "DevOps", headers: "Date,Service,Environment,Deploy Status,Incidents,MTTR_mins,Error Rate Pct,Uptime Pct,Build Time mins\n2026-06-10,payment-api,production,Failed,2,45,3.2,99.1,12\n2026-06-10,auth-service,production,Success,0,0,0.1,99.9,8\n2026-06-10,order-service,staging,Failed,1,120,5.7,98.4,15" },
              { id: "mlops", label: "MLOps", headers: "Date,Model,Version,Inference P99 ms,Accuracy Pct,Drift Score,Data Quality Pct,Training Status,GPU Util Pct\n2026-06-10,fraud-detector,v2.1,340,94.2,0.21,88,Healthy,72\n2026-06-10,demand-forecast,v1.8,85,91.5,0.38,76,Retraining,85\n2026-06-10,recommendation,v3.0,220,96.1,0.12,95,Healthy,68" },
              { id: "supply_chain", label: "Supply Chain", headers: "PO Number,Supplier,Item,Ordered Qty,Received Qty,Due Date,Actual Date,Lead Time Days,Unit Cost INR\nPO-2001,Tata Steel,M10 Bolts,1000,850,2026-06-05,2026-06-08,28,12.50\nPO-2002,Bajaj Elec,Motor 0.5HP,50,50,2026-06-03,2026-06-03,14,2800\nPO-2003,JSW Steel,HR Sheet,500,0,2026-06-01,,21,185" },
              { id: "retail", label: "Retail", headers: "Store,Date,Product,Category,Units Sold,Revenue INR,Stock Level,Reorder Point,Shrinkage Pct\nMumbai-01,2026-06-10,Samsung TV 43in,Electronics,5,275000,12,5,0.0\nMumbai-01,2026-06-10,iPhone 15 Case,Accessories,23,18400,3,20,1.2\nDelhi-02,2026-06-10,Nike Air Max,Footwear,8,72000,2,10,0.5" },
